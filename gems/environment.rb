...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/repertoire_core-0.3.3/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/repertoire_core-0.3.3/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/whois-0.5.2/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/whois-0.5.2/lib")
  ...
  @bundled_specs["repertoire_core"] = eval(File.read("#{dir}/specifications/repertoire_core-0.3.3.gemspec"))
  @bundled_specs["repertoire_core"].loaded_from = "#{dir}/specifications/repertoire_core-0.3.3.gemspec"
  ...
  @bundled_specs["whois"] = eval(File.read("#{dir}/specifications/whois-0.5.2.gemspec"))
  @bundled_specs["whois"].loaded_from = "#{dir}/specifications/whois-0.5.2.gemspec"
